...
{
    public class QRisk2_2014
    {



        public static double calcQRISK_F(int age,int b_AF,int b_ra,int b_renal,int b_treatedhyp,int b_type1,int b_type2,
            double bmi,int ethrisk,int fh_cvd,double rati,double sbp,
            int smoke_cat,int surv,double town)
    {
        ...
        if ((smoke_cat == 1))
            a += age_1 * 1 * 0.6891139747579299000000000;
        if ((smoke_cat == 2))
            a += age_1 * 1 * 0.6942632802121626600000000;
        if ((smoke_cat == 3))
            a += age_1 * 1 * -1.6952388644218186000000000;
        if ((smoke_cat == 4))
            a += age_1 * 1 * -1.2150150940219255000000000;
        ...
        if ((smoke_cat == 1))
            a += age_2 * 1 * -0.1765395485882681500000000;
        if ((smoke_cat == 2))
            a += age_2 * 1 * -0.2323836483278573000000000;
        if ((smoke_cat == 3))
            a += age_2 * 1 * 0.2734395770551826300000000;
        if ((smoke_cat == 4))
            a += age_2 * 1 * 0.1432552287454152700000000;
            
            
        //a += age_2 * smokeValue * -0.1765395485882681500000000;
        //a += age_2 * smokeValue * -0.2323836483278573000000000;
        //a += age_2 * smokeValue * 0.2734395770551826300000000;
        //a += age_2 * smokeValue * 0.1432552287454152700000000;
        ...
        public static double calcQRISK_M(int age,int b_AF,int b_ra,int b_renal,int b_treatedhyp,int b_type1,int b_type2,double bmi,
            int ethrisk,int fh_cvd,double rati,double sbp,int smoke_cat,int surv,double town)
        {
	        var survivor = new double[16]{
		        0,
		        0,
	        ...
	        /* Sum from interaction terms */        
            if ((smoke_cat == 1))
                a += age_1 * 1 * 0.9243747443632776000000000;
            if ((smoke_cat == 2))
                a += age_1 * 1 * 1.9597527500081284000000000;
            if ((smoke_cat == 3))
                a += age_1 * 1 * 2.9993544847631153000000000;
            if ((smoke_cat == 4))
                a += age_1 * 1 * 5.0370735254768100000000000;
            ...
            if ((smoke_cat == 1))
                a += age_2 * 1 * -0.0034466074038854394000000;
            if ((smoke_cat == 2))
                a += age_2 * 1 * -0.0050703431499952954000000;
            if ((smoke_cat == 3))
                a += age_2 * 1 * 0.0003216059799916440800000;
            if ((smoke_cat == 4))
                a += age_2 * 1 * 0.0031312537144240087000000;
